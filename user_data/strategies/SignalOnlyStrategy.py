    ...
    def bot_loop_start(self, current_time: datetime, **kwargs) -> None:
        ...
        try:
            ...
            for trade in open_trades:
                ...
                try:
                    if self.dp and hasattr(self.dp, '_exchange') and self.dp._exchange and hasattr(self.dp._exchange, '_api'):
                        symbol = trade.pair.replace("/", "").replace(":USDT", "USDT")
                        open_orders_raw = self.dp._exchange._api.swapV2PrivateGetTradeOpenOrders({"symbol": symbol})
                        ...
                        if not has_tp:
                            ...
                            if tp_price_str:
                                ...
                                try:
                                    ...
                                    tp_order = self.dp._exchange._api.swapV2PrivatePostTradeOrder({
                                        "symbol": api_symbol,
